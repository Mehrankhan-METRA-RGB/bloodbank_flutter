...
final LoadingController loadingController=Get.put(LoadingController());
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        onPressed: () =>_onSearchButton(context)
                           ...
                           const SizedBox(height: 60,width: 60,child: Padding(
  ...
  _onSearchButton(BuildContext context)async{
    ...
    if (bloodController.choiceData.value.isNotEmpty &&
      ...
      print(BloodController.instance.receiveFrom(
      ...
      await _filterSearchList(
          ...
          BloodController.instance.receiveFrom(
              bloodController.choiceData.value
          )!)
          ...
          MaterialPageRoute(
              builder: (context) => Donors(
                users: users,
                userBloodGroup: bloodController
                    .choiceData.value,
                userCity: geoController
                    .placeByGeo.value[2],
              )))).whenComplete(() => loadingController.isLoadingSearchButton.value=false);
    } else {
      App.instance.snakBar(
          text:
          "Please Point location on a map and Select Blood Group",
          bgColor: Colors.red);
    }
  }
  Future<List<UserModel?>> _filterSearchList(
    ...
    await FirebaseFirestore.instance
      ...
      List<QueryDocumentSnapshot<Map<String, dynamic>>> filtered = snap.docs
          .where((element) =>
          bGroups.contains(UserModel.fromMap(element.data()).group))
          .toList();
